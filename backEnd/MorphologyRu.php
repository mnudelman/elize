        ...
        $this->noun = [                           // СУЩЕСТВИТЕЛЬНОЕ
            'only' => [                           // единственное число
                'declension_1' => [               // 1 склонение
                    ...
                    'ablative-ends' => ['ой', 'ей,ёй', 'ий'],
                    'prepositional-ends' => ['е', 'е', 'ии']
                ],
                'declension_2' => [               // 2 склонение
                    'nominative-ends' => ['б,в,г,д,ж,к,л,м,н,р,с,т', 'ий', 'о', 'е', 'ие', 'ай'], // стол, гений, окно, поле, пение, чай
                    'genitive-ends' => ['а', 'я', 'а', 'я', 'я'],
                    'dative-ends' => ['у', 'ю', 'у', 'ю', 'ю'],
                    'accusative-ends' => ['б,в,г,д,ж,к,л,м,н,р,с,т', 'я', 'о', 'е', 'е'],
                    'ablative-ends' => ['ом', 'ем', 'ом', 'ем', 'ем'],
                    'prepositional-ends' => ['е', 'и', 'е', 'е', 'и']
                ],
                'declension_3' => [               // 3 склонение
                    'nominative-ends' => ['чь,шь'], // ночь, мышь
                    'genitive-ends' => ['чи,ши'],
                    'dative-ends' => ['чи,ши'],
        ...
        $this->adjective = [                            // ПРИЛАГАТЕЛЬНОЕ
            'only' => [  // единственное число
                'qualitative' => [                    // качественные
                    'nominative-ends' => ['ый', 'ий'],           // круглый, синий,
                    'genitive-ends' => ['ого', 'его'],
                    'dative-ends' => ['ому', 'ему'],
                    'accusative-ends' => ['ый', 'ий'],
                    'ablative-ends' => ['ым', 'им'],
                    'prepositional-ends' => ['ом', 'ем']
                ],
